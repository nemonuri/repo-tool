...
public readonly unsafe struct ImmutableByteArrayPremise : IByteSpanSourcePremise<ImmutableArray<byte>>
{
    public bool LessThanOrEqualAll(ImmutableArray<byte> left, ImmutableArray<byte> right) => 
        ByteSpanTheory.LessThanOrEqualAll(left.AsSpan(), left.AsSpan());

    public bool EqualsAll(ImmutableArray<byte> left, ImmutableArray<byte> right) =>
        ByteSpanTheory.EqualsAll(left.AsSpan(), left.AsSpan());
    ...
    public ImmutableArray<byte> Add(ImmutableArray<byte> left, ImmutableArray<byte> right) => UnsafeOperate(left, right, &ByteSpanTheory.Add);

    public ImmutableArray<byte> Subtract(ImmutableArray<byte> left, ImmutableArray<byte> right) => UnsafeOperate(left, right, &ByteSpanTheory.Subtract);

    public ImmutableArray<byte> Modulus(ImmutableArray<byte> left, ImmutableArray<byte> right) => UnsafeOperate(left, right, &ByteSpanTheory.Modulus);
