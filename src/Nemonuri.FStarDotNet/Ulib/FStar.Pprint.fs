// reference: https://github.com/FStarLang/FStar/blob/v2025.12.15/ulib/FStar.Pprint.fsti
// reference: https://github.com/FStarLang/FStar/blob/v2025.12.15/ulib/ml/app/FStar_Pprint.ml

namespace Nemonuri.FStarDotNet.FStar

open Nemonuri.FStarDotNet.Operators
open Nemonuri.FStarDotNet.Operators.Literals
open Nemonuri.FStarDotNet.TypeShadowing
...
module Pprint =
    ...
    /// val empty: document
    let empty: document = PPrintEngine.empty
