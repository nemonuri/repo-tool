// Reference: https://github.com/FStarLang/FStar/blob/v2025.12.15/fsharp/base/FStar_Int64.fs

module Nemonuri.FStarDotNet.FStar.List
...
let nth l i = List.item (Microsoft.FSharp.Core.Operators.int i) l
