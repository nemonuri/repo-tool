(**
    - Original source: https://github.com/fpottier/pprint/blob/20230830/src/PPrintMini.ml
    - Modifier: Nemonuri
*)
...
module PPrintMini =
    ...
    let rec private pretty' state (indent : int) (flatten : bool) doc =
        match doc with
    ...
    let pretty width doc =
        ...
        let state = { width = width; column = 0; output = output } in
